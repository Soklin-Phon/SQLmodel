...
- 🎯 Entry points to execute your program using `python -m <sqlmodel>` or `$ sqlmodel` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/Soklin-Phon/SQLmodel/branch/main/graph/badge.svg?token=SQLmodel_token_here)](https://codecov.io/gh/Soklin-Phon/SQLmodel)
[![CI](https://github.com/Soklin-Phon/SQLmodel/actions/workflows/main.yml/badge.svg)](https://github.com/Soklin-Phon/SQLmodel/actions/workflows/main.yml)

Awesome sqlmodel created by Soklin-Phon

## Install

from source
```bash
git clone https://github.com/Soklin-Phon/SQLmodel sqlmodel
cd sqlmodel
make install
```
...
```bash
$ sqlmodel run --port 8080
```

or

```bash
python -m sqlmodel run --port 8080
```

or

```bash
$ uvicorn sqlmodel:app
```
...
```bash
❯ sqlmodel --help
Usage: sqlmodel [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ sqlmodel create-user --help
Usage: sqlmodel create-user [OPTIONS] USERNAME PASSWORD
...
```bash
sqlmodel create-user admin admin --superuser
```
...
Run with `sqlmodel run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `sqlmodel create-user`.
...
-----------------------------------------------------
sqlmodel/__init__.py              4      0   100%
sqlmodel/app.py                  16      1    94%
sqlmodel/cli.py                  21      0   100%
sqlmodel/config.py                5      0   100%
sqlmodel/db.py                   10      0   100%
sqlmodel/models/__init__.py       0      0   100%
sqlmodel/models/content.py       47      1    98%
sqlmodel/routes/__init__.py      11      0   100%
sqlmodel/routes/content.py       52     25    52%
sqlmodel/routes/security.py      15      1    93%
sqlmodel/routes/user.py          52     26    50%
sqlmodel/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in sqlmodel/default.toml.
